...
<template>
    <div class="container mx-auto">
        <div class="navbar bg-base-100">
            <div class="flex-1">
                <RouterLink :to="{ name: 'home' }" class="btn btn-primary text-white normal-case text-xl">Easy Show</RouterLink>
            </div>
            ...
            <div class="flex-none gap-2">
                ...
                <div class="dropdown dropdown-end">
                    ...
                    <div tabindex="0" class="card card-compact dropdown-content bg-base-100 z-[1] mt-3 w-52 shadow">
                        <div class="card-body">
                            <span class="text-lg font-bold">จำนวนสินค้า {{ cartStore.summaryQuantity }}</span>
                            <span class="text-info">รวมทั้งหมด: {{ cartStore.summaryPrice }} บาท</span>
